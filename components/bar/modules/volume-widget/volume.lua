...
local utils = require("components.bar.modules.volume-widget.utils")
...
local widget_types = {
	icon_and_text = require("components.bar.modules.volume-widget.widgets.icon-and-text-widget"),
	icon = require("components.bar.modules.volume-widget.widgets.icon-widget"),
	arc = require("components.bar.modules.volume-widget.widgets.arc-widget"),
	horizontal_bar = require("components.bar.modules.volume-widget.widgets.horizontal-bar-widget"),
	vertical_bar = require("components.bar.modules.volume-widget.widgets.vertical-bar-widget"),
}
local volume = {}
